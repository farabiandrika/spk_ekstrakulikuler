          ...
          <div class="x_content">
            <table class="datatable-fixed-header table table-striped table-bordered">
              ...
              <tbody>
                ...
                <tr>
                  <td align="left" nowrap>{{$v->nama}}</td>
                  <td align="left" nowrap> @if($v->bobot==5) Sangat Penting
                  ...
                  <td align="left">@if($v->benefit) Benefit @else Cost @endif </td>
